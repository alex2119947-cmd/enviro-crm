...
st.sidebar.info("Версия: 4.4 (UI локализация)")
...
# ==============================================================================
    ...
    if object_type == 'Частный дом':
        ...
        with st.form("commercial_form", clear_on_submit=True):
            # ... (код анкеты для коммерческого объекта) ...
        ...
        if is_auth:
            ...
            with st.form("note_form", clear_on_submit=True):
                ...
                attached_files = st.file_uploader(
                    "Прикрепить файлы к комментарию (сметы, фото и т.д.):",
                    accept_multiple_files=True,
                        ...
                        if note.get('attachments'):
                            ...
                            for attachment in note['attachments']:
                                if os.path.exists(attachment['saved_path']):
                                    ...
                                    st.warning(f"Файл '{attachment['original_name']}' не найден.")
                        st.markdown("---")
